...
export default function EquipmentTemplatesPage() {
  ...
  const fetchEquipmentTemplates = async ({ page, limit, search, sortBy, sortOrder, filters }: {
    page: number
    limit: number
    search: string
    sortBy?: string
    ...
    return { data: (data as unknown as EquipmentTemplate[]) || [], total: count || 0 }
  }
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <DataTable
        ...
        fetchData={fetchEquipmentTemplates}
