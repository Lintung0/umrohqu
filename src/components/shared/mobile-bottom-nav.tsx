...
export default function MobileBottomNav() {
  ...
  if (pathname.startsWith("/admin") || pathname.startsWith("/travel-dashboard") || pathname.startsWith("/login") || pathname.startsWith("/register") || pathname.startsWith("/checkout") || pathname.startsWith("/search") || pathname.startsWith("/travel-site")) return null
