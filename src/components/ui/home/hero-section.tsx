...
import { IslamicPattern, IslamicCorner } from "@/components/ui/islamic-pattern";
...
export default function HeroSection() {
  return (
    <section className="relative min-h-[92vh] flex flex-col justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('/images/hero.webp')] bg-cover bg-bottom opacity-30 -z-20" />
      <div className="absolute inset-0 bg-gradient-to-t from-emerald-deep via-transparent to-emerald-deep/60 -z-10" />

      {/* Islamic pattern overlay */}
      <div className="absolute inset-0 text-white -z-[5]">
        <IslamicPattern opacity={0.04} />
      </div>

      {/* Decorative corners */}
      <div className="absolute top-0 left-0 text-white/20">
